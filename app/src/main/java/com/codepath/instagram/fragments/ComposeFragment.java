...
public class ComposeFragment extends Fragment {
    ...
    private final String imagePath = "ComposeFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        captureImageButton = view.findViewById(R.id.btnCaptureImage);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (photoFile == null || ivPostImage.getDrawable() == null) {
                    Log.e(imagePath, "No photo to submit");
    ...
    public File getPhotoFileUri(String fileName) {
        ...
        File mediaStorageDir = new File(getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES), imagePath);
